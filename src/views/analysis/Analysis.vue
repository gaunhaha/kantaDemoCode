<template>
    <div class="max-w-4xl mx-auto px-6">
        <div v-show="showInstruction" class="surface text-content p-5 mb-10 rounded-md shadow-md relative">
            <button class="absolute top-2 right-2 text-content-faint hover:text-accent" @click="showInstruction = false">
